...
public slots:    
    ...
    Q_INVOKABLE void retrieveRevision(const QString& database, const QString& documentID, bool resolveConflict = false);
    Q_INVOKABLE void retrieveDocument(const QString& database, const QString& documentID, const QString &callerID);
    Q_INVOKABLE void createDocument(const QString &database, QByteArray document, const QString &callerID);
    Q_INVOKABLE void updateDocument(const QString& database, const QString& documentID, QByteArray document, const QString &callerID);
    Q_INVOKABLE void deleteDocument(const QString& database, const QString& documentID, const QString& revision, const QString &callerID);
    Q_INVOKABLE void bulkDocumentsDelete(const QString &database, QByteArray &documents, const QString &callerID);
    ...
    Q_INVOKABLE void retrieveView(const QString &database, const QString &designDocName, const QString &viewName, QStringList keys = QStringList());

    Q_INVOKABLE void sslErrors(const QList<QSslError> &errors);
